...
public class Constants {
	...
	public static String BLOOD_FLUID = "BLOOD";
	public static String WATER_FLUID = "WATER";
	public static float MIN_FLUID_AMOUNT = 10f;
	public static float BLOOD_AMOUNT_MULTIPLIER = 10f;
	
	public static String CHECK_HELMENT = "IsHelment";
